...
def generate_launch_description():
    ...
    simple_goal_launch = package_share / "launch" / "camping_robot_simple_goal.launch.py"
    ...
    waypoints_arg = DeclareLaunchArgument(
        ...
        description="YAML waypoint file for patrol.",
    )
    ...
    return LaunchDescription(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(str(simple_goal_launch)),
